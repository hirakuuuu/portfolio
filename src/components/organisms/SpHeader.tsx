  ...
  return (
    <div className="block md:hidden">
      {isMenuVisible >= 0 && (
        <div
          className={
            "fixed left-0 top-0 z-10 block h-screen w-full -translate-y-[100vh] animate-slide-in-up bg-[#3d3d3b] " +
            (isMenuVisible === 1
              ? "animate-slide-in-up"
              : isMenuVisible === 0
      ...
      <div
        className="relative ml-2 mr-auto mt-4 block h-[20px] w-[25px] 
        before:absolute before:right-0 before:top-0 before:block before:h-[2px] before:w-full before:bg-[#4c5870] before:content-[''] 
        after:absolute after:bottom-0 after:right-0 after:block after:h-[2px] after:w-full after:bg-[#4c5870] after:content-[''] md:hidden"
